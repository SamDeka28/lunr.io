...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      ssl_note:
        "TLS should be terminated at your DNS/CDN provider (Vercel, Cloudflare, etc.) until auto-SSL ships. For apex domains, use CNAME flattening or an ALIAS/ANAME record.",
    });
  } catch (error: any) {
