...
import { FileText, Loader2, ChevronDown, ChevronRight, Globe, Lock, Link2, Plus, X } from "lucide-react";
...
export default function PageEditForm({ page, userLinks }: { page: any; userLinks?: any[] }) {
  ...
  const [backgroundType, setBackgroundType] = useState<"solid" | "gradient">(pageContent.backgroundType || "solid");
    ...
    <div className="flex h-[calc(100vh-73px)]">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-3xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-neutral-text mb-2">Edit page</h1>
            <p className="text-sm text-neutral-muted">
              Update your custom landing page
            </p>
          </div>
              ...
              <div className="space-y-4">
                ...
                {pageLinks.length > 0 && (
                  <div className="space-y-2">
                    ...
                    {pageLinks.length > 3 && (
                      <p className="text-xs text-center opacity-60" style={{ color: textColor }}>
