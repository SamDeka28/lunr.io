...
export function QRControls({
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      router.push(`/dashboard/qr?${params.toString()}`);
    }, 300);
    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-4">
        ...
        <div className="relative flex-1 sm:flex-none" ref={filterMenuRef}>
          ...
          {showFilterMenu && (
            <div className="absolute top-full right-0 mt-2 w-64 bg-white rounded-2xl border border-neutral-border/80 shadow-float z-50 py-2">
              ...
              <div className="px-4 py-2">
                <button className="w-full px-3 py-1.5 rounded-full text-xs font-semibold bg-primary text-white shadow-button hover:bg-bright-indigo transition-all">
                  Apply filters
                </button>
              </div>
            </div>
